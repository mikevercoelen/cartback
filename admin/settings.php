...
class CartBack_Settings {
	...
	function render_uninstall_remove_field() {
		...
		echo '<p class="description">' . __( 'Check this box if you\'d like these settings to be cleared and removed from the database when you uninstall this plugin.', 'cartback' ) . '</p>';
